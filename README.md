...
The script will prompt you to choose between **Claude Code** and **Codex CLI**, then walk you through each step interactively. Once complete, you'll be inside the `dbxf_vibe_de` directory with everything configured.
